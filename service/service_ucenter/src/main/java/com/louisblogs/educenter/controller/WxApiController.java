package com.louisblogs.educenter.controller;
...
import com.louisblogs.educenter.utils.ConstantWxUtils;
import com.louisblogs.educenter.utils.HttpClientUtils;
...
public class WxApiController {
	...
	public String getWxCode() {
		...
		try {
			...
			throw new LouisblogsException(20001,e.getMessage());
		}

		// 防止csrf攻击（跨站请求伪造攻击）
		//String state = UUID.randomUUID().toString().replaceAll("-", "");//一般情况下会使用一个随机数
		String state = "louisblogs";//为了让大家能够使用我搭建的外网的微信回调跳转服务器，这里填写你在ngrok的前置域名
