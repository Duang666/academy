...
import com.louisblogs.eduservice.entity.EduCourseDescription;
import com.louisblogs.eduservice.entity.frontvo.CourseFrontVo;
import com.louisblogs.eduservice.entity.frontvo.CourseWebVo;
import com.louisblogs.eduservice.entity.vo.CourseInfoVo;
import com.louisblogs.eduservice.entity.vo.CoursePublishVo;
import com.louisblogs.eduservice.mapper.EduCourseMapper;
import com.louisblogs.eduservice.service.EduChapterService;
import com.louisblogs.eduservice.service.EduCourseDescriptionService;
...
public class EduCourseServiceImpl extends ServiceImpl<EduCourseMapper, EduCourse> implements EduCourseService {
	...
	public String saveCourseInfo(CourseInfoVo courseInfoVo) {
		...
		if (insert == 0) {
			//添加失败
			throw new LouisblogsException(20001, "添加课程信息失败");
		}
	...
	public void updateCourseInfo(CourseInfoVo courseInfoVo) {
		...
		if (update == 0) {
			throw new LouisblogsException(20001, "修改课程信息失败");
		}
	...
	public void removeCourse(String courseId) {
		...
		if (result == 0) { //失败返回
			throw new LouisblogsException(20001, "删除失败");
		}
	}
